             ...
             child: Column(
              ...
              SizedBox(
               ...
               child: ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(255, 121, 95, 3),shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(20)))),
                onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) =>terjma()));
               }, child: Text("Translation in Urdu",style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 253, 253, 253),))),),
                     SizedBox(height: 20,),
                     SizedBox(
               height: 60,width: 230,
               child: ElevatedButton(
               ...
               child: ElevatedButton(
                   style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(255, 121, 95, 3),shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(20)))),
                   onPressed: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context) =>taaruf()));
               }, child: Text(" سورہ یٰسٓ كا تعارف  " ,style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 253, 253, 253),))),),
                   SizedBox(height: 20,),
                     SizedBox(
               height: 60,width: 230,
               child: ElevatedButton(
                   style: ElevatedButton.styleFrom(backgroundColor: Color.fromARGB(255, 121, 95, 3),shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(20)))),
                   onPressed: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context) =>fyzayle()));
               }, child: Text(" سورہ يس کے فضائل",style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 253, 253, 253),))),),
